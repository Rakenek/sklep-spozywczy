      ...
      <div class="row">
		...
		<c:forEach items="${products}" var="product">
              ...
              <div class="card h-100">
                <a href="${contextRoot}/show/${product.id}/product"><img class="card-img-top homesiteimg" src="${images}/${product.code}.jpg" alt=""></a>
                <div class="card-body">
                  <h4 class="card-title">
                    <a href="${contextRoot}/show/${product.id}/product">${product.name}</a>
                  </h4>
                  <h5>${product.unitPrice} zł / ${product.unit}</h5>
